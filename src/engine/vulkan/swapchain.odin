...
initVkSwapChain :: proc() {
    ...
    g_vulkan_context.swapchain.images = make([]VkImage, img_count, g_vulkan_context.arena_allocator)
    g_vulkan_context.swapchain.depth_images = make([]VkImage, img_count, g_vulkan_context.arena_allocator)
...
destroyVkSwapChain :: proc() {
    ...
    for img in g_vulkan_context.swapchain.depth_images {
        ...
        vk.DestroyImage(g_vulkan_context.logic_device.handle, img.handle, g_vulkan_context.vk_allocator)
        vk.FreeMemory(g_vulkan_context.logic_device.handle, img.memory, g_vulkan_context.vk_allocator)
    }
